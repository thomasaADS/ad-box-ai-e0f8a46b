...
const faqData = [
  {
    q: 'מה ההבדל בין ARIA לכלים אחרים?',
    a: 'ARIA הוא הכלי היחיד שמשלב יצירת קריאייטיב, מחקר קהלים, אופטימיזציה ודוחות - הכל במקום אחד, עם AI שמותאם ספציפית לשוק הישראלי. בעוד שכלים אחרים מתמקדים בתחום אחד, ARIA מספק פתרון מקצה לקצה.',
  },
  {
    q: 'איך ARIA מנהל את תקציב הפרסום?',
    a: 'ARIA משתמש באלגוריתמי AI מתקדמים שמנתחים את ביצועי הקמפיינים בזמן אמת ומחלקים את התקציב בצורה אופטימלית בין המודעות והקהלים השונים. המערכת מזהה אוטומטית מה עובד ומעבירה תקציב למודעות המצליחות ביותר.',
  },
  {
  ...
  {
    q: 'האם צריך ידע טכני?',
    a: 'בכלל לא. ARIA נבנה כדי שכל אחד יוכל ליצור קמפיינים מקצועיים. פשוט תזין את הקישור לאתר שלך, והמערכת עושה את כל השאר - מהקופי ועד העיצוב.',
  },
  {
    q: 'איך מתחילים?',
