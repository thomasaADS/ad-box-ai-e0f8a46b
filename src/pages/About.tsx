...
export default function About() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-background via-muted/30 to-background relative overflow-hidden">
      <SEOHead
        title="אודות ARIA - הסיפור שלנו"
        description="ARIA היא פלטפורמת AI מתקדמת שמהפכת את עולם השיווק הדיגיטלי. הקמנו ב-2024 עם חזון ברור: להפוך שיווק מורכב לפשוט וזמין לכולם."
        keywords="אודות ARIA, מי אנחנו, חברת שיווק, AI שיווק, סיפור ARIA"
        canonicalUrl="/about"
      />
      ...
      <main className="container mx-auto px-4 py-16 relative z-10">
        ...
        <div className="text-center mb-16 animate-fade-in">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
            <span className="font-bold text-2xl text-primary">ARIA</span> היא פלטפורמת AI מתקדמת שמהפכת את עולם השיווק הדיגיטלי
          </p>
        </div>
          ...
          <div className="grid md:grid-cols-2 gap-10 items-center">
            <div>
              ...
              <p className="text-lg text-muted-foreground leading-relaxed mb-4">
                כשהקמנו את <span className="font-bold text-primary">ARIA</span> ב-2024, היה לנו חזון ברור: 
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-16">
          <Card className="p-8 bg-gradient-to-br from-blue-50/50 to-cyan-50/50">
            ...
            <p className="text-lg text-muted-foreground leading-relaxed">
              להפוך את ARIA לפלטפורמת השיווק המובילה בעולם, 
        ...
        <Card className="p-12 text-center bg-gradient-to-r from-purple-500/10 to-blue-500/10 border-2 border-primary/20">
          ...
          <p className="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">
            צור את הקמפיין הראשון שלך עכשיו וגלה איך ARIA משנה את חוקי המשחק
          </p>
